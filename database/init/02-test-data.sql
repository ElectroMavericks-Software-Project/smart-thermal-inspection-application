...
('AZ-1649', 'P001', '500 KVA', 'Central', 'Distribution', 'Main Street Junction', true, 'admin', 'media/baseline/AZ-1123.jpg', CURRENT_TIMESTAMP - INTERVAL '120 days'),
('AZ-2750', 'P002', '750 KVA', 'North', 'Distribution', 'Industrial Area Block A', false, 'admin', 'media/baseline/AZ-3333.jpg', CURRENT_TIMESTAMP - INTERVAL '110 days'),
('AZ-3891', 'P003', '1000 KVA', 'South', 'Power', 'Residential Complex Gate', true, 'admin', 'media/baseline/AZ-3456.jpg', CURRENT_TIMESTAMP - INTERVAL '100 days'),
('AZ-4512', 'P004', '300 KVA', 'East', 'Distribution', 'Commercial Plaza Entrance', false, 'admin', 'media/baseline/AZ-4343.png', CURRENT_TIMESTAMP - INTERVAL '90 days'),
('AZ-5623', 'P005', '650 KVA', 'West', 'Distribution', 'Highway Service Station', false, 'admin', 'media/baseline/AZ-8888.jpg', CURRENT_TIMESTAMP - INTERVAL '80 days'),
('AZ-6734', 'P006', '850 KVA', 'Central', 'Power', 'City Center Mall', true, 'admin', 'media/baseline/AZ-8890.jpg', CURRENT_TIMESTAMP - INTERVAL '70 days'),
('AZ-7845', 'P007', '400 KVA', 'North', 'Distribution', 'University Campus Main Gate', false, 'admin', 'media/baseline/AZ-8989.jpg', CURRENT_TIMESTAMP - INTERVAL '60 days'),
('AZ-8956', 'P008', '550 KVA', 'South', 'Distribution', 'Hospital Emergency Wing', false, 'admin', 'media/baseline/AZ-9990.jpg', CURRENT_TIMESTAMP - INTERVAL '50 days'),
('AZ-9067', 'P009', '900 KVA', 'East', 'Power', 'Manufacturing Plant Section B', true, 'admin', 'media/baseline/AZ-0000.png', CURRENT_TIMESTAMP - INTERVAL '40 days');
